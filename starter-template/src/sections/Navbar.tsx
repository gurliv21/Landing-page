    ...
    return (
        <section className="py-4 lg:py-8">
            <div className="container">
                <div className="grid grid-cols-2 lg:grid-cols-3 border border-white/15 px-4 md:pr-2 rounded-full items-center">
                    <div>
                        <Image src={logoImage} alt="Layers logo" className="h-9 w-auto ml-2 p-1"></Image>

                    </div>
                    <div className="lg:flex justify-center text-center hidden">
